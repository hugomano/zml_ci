...
def _cuda_impl(mctx):
    ...
    http_archive(
        ...
        # url = "https://github.com/zml/pjrt-artifacts/releases/download/v4.0.0/pjrt-cuda_linux-amd64.tar.gz",
        # sha256 = "5708a4bc7a84edb77040e06121023b2ebadd7ee83d457d0b304672f1460b28b6",
    )
